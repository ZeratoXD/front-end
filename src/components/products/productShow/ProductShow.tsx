...
function ExibirProduto({ produto }: ExibirProdutoProps) {
    return (
        <>
            <div className="grid grid-cols-2 gap-1 w-full h-full items-center px-6 py-2 my-4">
                <div>
                    <div className="relative max-w-fit mx-3 mt-3 flex self-center h-60 overflow-hidden rounded-xl">
                        <img className="object-cover size-max" src={produto.foto} alt="product image" />
                ...
                <div>
                    <div className="mt-4 px-5 pb-5">
                        <a href="#">
                            <h5 className="text-3xl font-semibold tracking-tight text-slate-900">{produto.nome}</h5>
                        </a>
                        <div className="mt-2 mb-5 flex items-center justify-between">
                            <p>
                                <span className="text-3xl font-bold text-black-new">R${produto.preco}</span>
                        ...
                        <div className="descricao mb-5">
                            <h2 className="text-2xl font-semibold mb-4">Sobre o produto</h2>
                        ...
                        <div className="mb-5 flex flex-row items-center">
                            ...
                            <p><b>Validade:</b> <span>{" "}
                                {new Intl.DateTimeFormat(undefined, {
                                    dateStyle: "long",
                                }).format(new Date(produto.validade))}</span></p>
                        </div>
                        <div className="vendedor mb-5 flex flex-row">
                            <i className="fa fa-user px-2 text-dark-orange self-center" aria-hidden="true"></i>
                            <p className="self-center"><b>Vendedor:</b> <span>{produto.usuario?.nome}</span></p>
                        </div>
                        <div className="vendedor mb-5 flex flex-row items-center justify-center">
                            <p className="rounded-full h-12">{produto.usuario?.foto}</p>
                        </div>
